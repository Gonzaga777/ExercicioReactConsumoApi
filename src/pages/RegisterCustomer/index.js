                    ...
                    <Col>
                        <Form>
                            ...
                            <Form.Group className="mb-3" controlId="document">
                                ...
                                <Form.Control type="text" placeholder="Digite Seu Documento"
                                    value={customer.document}
                                    onChange={(event) => { setCustomer({...customer, document: event.target.value}) }} />
                            </Form.Group>
                            <Form.Group className="mb-3" controlId="tel">
                                <Form.Label>Telefone:</Form.Label>
                                <Form.Control type="text" placeholder="Digite Seu Telefone (Com DDD)"
                                    value={customer.tel}
                            ...
                            {successRegister ?  <Alert key='success' variant='success'>
                    Usuario Salvo Com Sucesso! <AiFillCheckCircle size="25" />
                </Alert> : ''}
